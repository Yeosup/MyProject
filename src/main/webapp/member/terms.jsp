...
<head>
    ...
    <script defer src="terms.js"></script>
</head>
<body>
    <div class="wrap">
        <div class="logo">
        ...
        <div class="contents">
          <form action="memberRegister.jsp" method="post" id="form__wrap">
            <div class="terms__check__all">
              <input type="checkbox" name="checkAll" id="checkAll" />
              <label for="checkAll">렌미노 이용약관, 개인정보 수집 및 이용, 프로모션 정보수신(선택)에<br />모두 동의합니다.</label>
            </div>
            <ul class="terms__list">
              <li class="terms__box">
                <div class="input__check">
                  <input
                    ...
                    required
                  />
                  <label for="termsOfService" class="required">렌미노 이용약관 동의</label>
                </div>
                <div class="terms__content">
                    렌미노 서비스를 이용해 주셔서 감사합니다. 
                    본 약관은 다양한 렌미노 서비스의 이용과 관련하여
                    렌미노 서비스를 제공하는 렌미노 주식회사(이하 ‘렌미노’)와 이를 이용하는
                    렌미노 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며,
                    아울러 여러분의 렌미노 서비스 이용에 도움이 될 수 있는 유익한
                    정보를 포함하고 있습니다. 렌미노 서비스를 이용하시거나 렌미노 서비스
              ...
              <li class="terms__box">
                ...
                <div class="terms__content">
                    개인정보보호법에 따라 렌미노에 회원가입 신청하시는 분께 수집하는
              ...
              <li class="terms__box">
                <div class="input__check">
                  ...
                  />
                  <label for="allowPromotions" class="choice">프로모션 정보 수신 동의</label>
                </div>
                <div class="terms__content">
                  렌미노에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(렌미노 앱
                  알림 또는 문자), 이메일로 받아보실 수 있습니다. 일부 서비스(별도
                  회원 체계로 운영하거나 렌미노 가입 이후 추가 가입하여 이용하는
            ...
            <input type="submit" class="next-button" disabled value="다음">
          </form>
        </div>
      </div>
      <script>
