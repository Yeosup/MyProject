            ...
            <div class="home_content">
                <div class="profile_box">
                    ...
                    <div class="profileEdit">
                    	<form id="writeForm" action="sendMessage.do" method="post">
                    		<div class="messageBox"><textarea id="writeOK" rows="10" cols="65" name="message">>>Re: 

 ${msg.message } </textarea></div>
	                    	...
	                    	<input type="submit" value="답장 하기 >>" id="profileEditBtn">
                    	</form>
                    </div>
