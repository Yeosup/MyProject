                ...
                <div class="profile_box">
                    ...
                    <div class="profileEdit">
                    	<form id="writeForm" action="sendMessage.do" method="post" onsubmit="return formSubmit()">
                    		<div class="messageBox"><textarea id="writeOK" rows="10" cols="65" name="message">${msg.message } </textarea></div>
	                    	...
	                    	<input type="submit" value="다시 보내기 >>" id="profileEditBtn">
                    	</form>
                    </div>
        						...
        						<div class="writerInfo">
					            	...
					            	<div id=settingContents>
						            	...
						            	<div class="settingContents">
						                	<p class="delete"><a href="deleteMyMessage.do?no=${send.no }&id=${userInfo.id }" onclick="deleteChk()">삭제</a></p>
						            	</div>
