...
<head>
    ...
    <link rel="stylesheet" href="main_friend.css">
            ...
            <div class="home_content">
                <div class="profile_box">
                    ...
                    <div class="profileEdit">
	                    <a href="#"><input type="button" value="친구 편집" id="profileEditBtn"></a>
                    </div>
                    						...
                    						<div class="writerInfo">
					                        	...
					                        	<i class='bx bx-dots-vertical-rounded'></i>
						                        	<div class="settingContents">
						                        		<p class="delete"><a href="deleteFriend.do?id=${userInfo.id }&friendId=${friendList.friendId}" onclick="return confirm('정말 삭제하시겠습니까?');">삭제</a></p>
						                        	</div>
					                        	</div>
			                    			</div>
                    					</td>
