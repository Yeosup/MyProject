...
<head>
    ...
    <link rel="stylesheet" href="main_message.css">
                ...
                <div class="profile_box">
                    ...
                    <div class="profileEdit">
                    	<div class="messageBox">
	                    	<img src="${pageContext.request.contextPath}/image/mail.png" alt="mail">
	                    	<!-- <p>친구 등록 후 메세지를 보낼 친구를 선택해 주세요</p> -->
                    	</div>
                    	<!-- <div class="messageBox">
                    		<textarea rows="10" cols="65" name="message" readonly></textarea>
                    		<p>친구 등록 후 메세지를 보낼 친구를 선택해 주세요</p>
                    	</div> -->
	                    <p id="profileEditBtn">친구 등록 완료 후 + 버튼으로 친구를 추가해 주세요</p>
                    </div>
