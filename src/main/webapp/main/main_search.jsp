...
<head>
    ...
    <link rel="stylesheet" href="main_search.css">
        					...
        					<td>
        						<div class="writerInfo">
					            	...
					            	<form action="addFriend.do" method="post">
					            		...
					            		<input type="hidden" name="profile" value="${dto.profile }">
					            		<input type="hidden" name="nickname" value="${dto.nickname }">
					            		<input type="hidden" name="promise" value="${dto.promise }">
        				...
        				<tr>
        					...
        					<td>
        						<div class="writerInfo">
					            	...
					            	<i class='bx bx-check'></i>  <!-- /* 글 수정 삭제 버튼 추가해야함 */ -->
			                	</div>
        					</td>
        				</tr>
        			</c:forEach>
