...
<head>
    ...
    <link rel="stylesheet" href="main_friendList.css">
										...
										<div class="writerInfo">
					                        ...
					                        <div id=settingContents>
					                        	...
					                        	<div class="settingContents">
					                        		<c:choose>
					                        			<c:when test="${dto.id eq userInfo.id }">
					                        				<p class="modify"><a href="mainModify.do?no=${dto.no }&id=${userInfo.id }">수정</a></p>
					                        				<p class="delete"><a href="mainDelete.do?no=${dto.no }&id=${userInfo.id }" onclick="return confirm('정말 삭제하시겠습니까?');">삭제</a></p>
					                        			</c:when>
					                        			<c:otherwise>
