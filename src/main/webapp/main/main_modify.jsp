...
<head>
    ...
    <link rel="stylesheet" href="main_modify.css">
	                    ...
	                    <table>
							<%-- <c:forEach var="dto" items="${dto}"> --%>
								<tr>
									...
									<td>
										<form action="mainModifyOK.do" method="post">
										<div class="writerInfo">
					                        ...
					                        <div id=settingContents>
					                        	...
					                        	<div class="settingContents">
					                        		<input class="OK" type="submit" value="완료">
					                        		<input type="hidden" name="no" value="${dto.no }">
					                        	</div>
					                        </div>
					                          <!-- /* 글 수정 삭제 버튼 추가해야함 */ -->
			                    		</div>
			                    		<div class="contents"><input id="contents" type="text" name="contents" value="${dto.contents }"></div>									
										</form>
										<div class="reply">
											<a href="reply.do?no=${dto.no}&id=${userInfo.id }"><i class='bx bx-message-rounded'></i></a>
											<c:choose>
        				...
        				<tr>
        					<td>
        						<div class="writerInfo">
					            	...
					            	<i class='bx bx-dots-vertical-rounded'></i>  <!-- /* 글 수정 삭제 버튼 추가해야함 */ -->
			                	</div>
        					</td>
        				</tr>
        			</c:forEach>
