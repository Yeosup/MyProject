...
<head>
    ...
    <link rel="stylesheet" href="messageSend.css">
                ...
                <div class="profile_box">
                    ...
                    <div class="profileEdit">
                    	<div class="messageBox">
                    		<textarea rows="10" cols="65" name="message" readonly></textarea>
                    		<p>메세지 전송이 완료 되었습니다.</p>
                    	</div>
	                    <input type="button" value="메세지 보내기 >>" id="profileEditBtn" onclick="chkFriendId()">
                    </div>
                    						...
                    						<div class="friendImg">
					                    		<a href="main_profile.do?id=${friendList.friendId }">
						                        	<c:choose>
							                            ...
							                            <c:otherwise>
							                            	<img id=myImg src="http://localhost:8080/Project/upload/${friendList.profile }">
							                            </c:otherwise>
						                            </c:choose>
					                        	</a>
		                    				</div>
        				...
        				<tr>
        						...
        						<div class="writerImg">
				                	<a href="main_profile.do?id=${read.friendId }">
					                	<c:choose>
						            		...
						            		<c:otherwise>
						                    	<img id=myImg src="http://localhost:8080/Project/upload/${read.profile }">
						                	</c:otherwise>
					                	</c:choose>
				                	</a>
		                    	</div>
        					...
        					<td>
        						<div class="writerInfo">
					            	...
					            	<form action="messageReply.do" method="post">
					            		<input type="hidden" name="id" value="${userInfo.id }">
					            		<input type="hidden" name="friendId" value="${userInfo.friendId }">
        						...
        						<div class="writerImg">
				                	<a href="main_profile.do?id=${send.friendId }">
					                	<c:choose>
						            		...
						            		<c:otherwise>
						                    	<img id=myImg src="http://localhost:8080/Project/upload/${send.messageProfile }">
						                	</c:otherwise>
					                	</c:choose>
				                	</a>
		                    	</div>
